/**
 * Injects a Goated Clip button into the Rumble video controls.
...
export function injectGoatedClipButton() {
  const controlsBar = document.querySelector('.video-controls__right');
  if (controlsBar && !document.getElementById('goated-rumble-clip-btn')) {
    const btn = document.createElement('button');
    btn.id = 'goated-rumble-clip-btn';
    btn.className = 'rumble-btn rumble-btn--success';
...
/**
 * Starts recording the Rumble video stream using MediaRecorder.
...
export function startRecording() {
  ...
  mediaRecorder.onstop = () => {
    ...
    a.href = url;
    a.download = 'goated-rumble-clip.webm';
